...
export default function Page() {
  ...
  const { reservationNumber, reservationDate, status, reservationItems, pickupDeadline, cancelDetail } = reservation;
  ...
  return (
    <>
      ...
      <section className="flex flex-col items-start p-5 gap-[1.875rem] w-full rounded-2xl bg-white">
        <p className="w-full text-title-content-m text-gray900">예약 취소</p>
        <Stack className="gap-[1.875rem]" gap={30} divider={<div className="w-full h-[1px] bg-gray100"></div>}>
