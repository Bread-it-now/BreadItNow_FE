  ...
  return (
    <>
      <section className="flex flex-col justfiy-center items-start px-5 pt-6 pb-[1.875rem] gap-[1.875rem] w-full rounded-b-2xl bg-white">
        ...
        <Button variant="primary" type="button" fullWidth aria-label="앱 알림 켜기" onClick={() => {}}>
          앱 알림 켜기
        </Button>
      </section>
      <section className="rounded-2xl w-full bg-white">
        <div className={'flex items-center gap-5 px-5 py-[1.875rem] rounded-2xl w-full bg-white'}>
      ...
      <section className="px-5 py-[1.875rem] rounded-2xl w-full bg-white">
        <Stack divider={<div className="w-full h-[1px] bg-gray100"></div>}>
          <div className={'flex items-center gap-5 w-full bg-white'}>
            <div className={'flex flex-col items-start gap-[0.625rem] w-full'}>
              <p className="text-title-content-m text-gray900 w-full">빵 알림</p>
              {/* <p className="text-title-content-xs text-gray500 font-normal whitespace-nowrap">
                중요한 소식을 앱 실행 없이 실시간으로 알 수 있어요.
              </p> */}
            </div>
            {<ToggleSwitch type="APP_NOTIFICATION" checked />}
