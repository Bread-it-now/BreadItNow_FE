...
import { getBakeryInfo } from '@/lib/api/bakery';
...
const OperatingSection = ({ bakeryId }: { bakeryId: number }) => {
      ...
      {bakery && (
        <Fragment>
          <section className="w-full bg-white rounded-b-[0.625rem]">
            <OperatingStatusCard name={bakery.name} operatingStatus="TEMPORARY_CLOSED" type="GENERAL" />
          </section>
...
export default function Page() {
  return (
    <>
      <OperatingSection bakeryId={bakeryId} />
