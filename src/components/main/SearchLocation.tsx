...
const SearchBar = forwardRef<HTMLInputElement, SearchInputProps>(function SearchBar(
  ...
  return (
    <label
      ...
      htmlFor={name}>
      <button type="button" onClick={onEnter} className="flex w-5 h-5 items-center justify-center" aria-label="검색">
      ...
      <input
        ...
        className="flex-1 bg-transparent text-sm border-none outline-none px-2 text-black"
      />
