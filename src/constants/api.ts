...
export const API_END_POINT = {
  ...
  UPDATE_USER_INFO: () => `${MODULE.CUSTOMER}/${API_VERSION_PREFIX}/${CONTROLLER.CUSTOMER.CUSTOMER}/me/info`,
  VALIDATE_PASSWORD: () =>
    `${MODULE.CUSTOMER}/${API_VERSION_PREFIX}/${CONTROLLER.CUSTOMER.CUSTOMER}/me/verify-password`,
  /** CUSTOMER - REGION */
